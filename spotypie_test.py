...
class testSpotipy(unittest.TestCase):
    ...
    def test_searchTrack(self):
        ...
        print("\n"+"*"*50+"\n")
        print("\nTESTCASE CORRECT PARAMETERS <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< TESTCASE")
        objSp=SpotyPie("credenciales.txt","Arma_tu_biblio_.db")
    ...
    def test_addTracktoMyPlaylist(self):
        ...
        objSp=SpotyPie("credenciales.txt","Arma_tu_biblio_test.db")
    ...
    #
        ...
        print("\n"+"*"*50)
        print("TEST showMyPlaylist() <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< makeSync()")
        print("\n"+"*"*50+"\n")
